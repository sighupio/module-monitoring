...
- Prometheus Adapter config is now generated via configMapGenerator instead of being a simple file as used as a resource.
...
To upgrade this core module from `v3.4.0` to `vTBD`, execute the following:
