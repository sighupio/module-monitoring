...
|-----------------------|-----------------------------------------------------------------------------------------------------------------------------------------|------------------|
| `alertmanager`        | [`v0.31.1`](https://github.com/prometheus/alertmanager/releases/tag/v0.31.1)                                                            | No update        |
...
| `mimir`               | [`v3.0.4`](https://github.com/grafana/mimir/releases/tag/mimir-3.0.4)                                                                   | vNo update       |
