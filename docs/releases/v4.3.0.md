...
Upgraded to Grafana and pulled the updated dashboards from kube-prometheus, which add the new `k8s-resources-nodes-overview` dashboard showing an overview of the resource usage across the cluster nodes.
