# Monitoring Module Release v3.6.0
...
This release updates to `kube-prometheus` v0.16.0 including bug fixes and new features, and adds support for Kubernetes 1.33.x.
